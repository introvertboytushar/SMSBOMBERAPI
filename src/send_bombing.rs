...
// ═══════════════════════════════════════════════════
//  🚫 BLOCKED NUMBERS — এখানে block করতে চাও এমন
//  number গুলো যোগ করো
//  format: "01XXXXXXXXX" অথবা "8801XXXXXXXXX"
// ═══════════════════════════════════════════════════
const BLOCKED_NUMBERS: &[&str] = &[
    
    // "01700000000",   ← এভাবে যোগ করো
    // "01800000000",
    // "8801700000000",
...
let number  = std::sync::Arc::new(number);
let bd_no   = std::sync::Arc::new(bd_no);
let bd_full = std::sync::Arc::new(bd_full);
let plus_bd = std::sync::Arc::new(plus_bd);
    // ═══════════════════════════════════════════════
